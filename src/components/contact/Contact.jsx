        ...
        <div>
            ...
            <div className='w-full flex flex-col lg:flex-row justify-between bg-green-5 gap-4'>
                <div className='lg:w-[40%] w-full bg-slate-950 h-[560px] rounded-tr-[40px]'>
                     ...
                     <div className='m-8'>
                        <button className='bg-white rounded-[30px] p-2 w-[30%] '>
                            <span></span>
                            Google Play
                        </button>
                        <button className='bg-white rounded-[30px] p-2 ml-10 w-[25%]'>
                            <span></span>
                            App Store
                        </button>
                     </div>
                     ...
                     <img
                    className="px-8 h-64 object-cover mb-2 cursor-pointer"
                    src={charts_1}
                    alt="contactImg"
                />
                     </div>
                ...
                <div className='px-8 mt-6'>
                        <h1 className='text-2xl text-white font-bold'>Dashboard or User Interface</h1>
                     ...
                     <div className='rounded-[50px] mt-10'>
                     <img
                    className="px-8 h-64 object-cover mb-2 cursor-pointer"
